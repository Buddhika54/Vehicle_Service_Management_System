...
export default function AdvisorDashboard({ stats }) {
    return (
        <AppLayout>
            <Head title="Service Advisor Dashboard" />

            <div className="p-6">
                <h1 className="text-2xl font-bold text-gray-800 mb-6">Service Advisor Dashboard</h1>
